...
// EL coste es del orden de O(N) donde N es el numero de elementos de la lista ya que hace del orden de N iteraciones cada una de coste constante cada una

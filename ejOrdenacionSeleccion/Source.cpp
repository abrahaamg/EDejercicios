 ...
 */
  ...
  */
  ...
  /*
    ...
    ---------------------------------------------------------
    Componente 1: Ibrahim Garcés El Bssita
    Componente 2: Paula López Solla
  */
  //@ </answer>
...
//coste cuadrático O(n^2) sindo n el numero de nodos, ya que tenemos un bucle while que recorre la lista y dentro del mismo hacemos operaciones de orden constante, 
// salvo la función de minimun que es de orden lineal 
